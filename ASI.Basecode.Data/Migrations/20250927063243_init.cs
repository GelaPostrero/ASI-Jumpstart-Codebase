        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MenuDescription = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    LogMenuID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    MenuID = table.Column<int>(type: "int", nullable: false),
                    ActionType = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    FieldChange = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LogMenu", x => x.LogMenuID);
                    table.ForeignKey(
                        name: "FK_LogMenu_Menu_MenuID",
                        column: x => x.MenuID,
                        principalTable: "Menu",
                        principalColumn: "MenuID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_LogMenu_Users_UpdatedBy",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LogMenu_MenuID",
                table: "LogMenu",
                column: "MenuID");

            migrationBuilder.CreateIndex(
                name: "IX_LogMenu_UpdatedBy",
                table: "LogMenu",
                column: "UpdatedBy");
